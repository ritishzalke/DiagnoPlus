...
class Receipt3 extends StatefulWidget {
  // const Receipt({Key? key}) : super(key: key);

  @override
  _Receipt3State createState() => _Receipt3State();
}

class _Receipt3State extends State<Receipt3> {
  User user;
  UserModel userModel;
        ...
        children: [
          ...
          Row(
              children: [
                Container(
                  ...
                  child: Text("Doctor's Name: Doctor 2", style: TextStyle(fontSize: 20),),
                ),
              ]
          ),
          FittedBox(
          ...
          Row(
            children: [
              Container(
                margin: EdgeInsets.only(left: 10,bottom: 15),
                child: Text("Time: 8:00",style: TextStyle(fontSize: 20),),
              ),
            ],
          ),
          Divider(
