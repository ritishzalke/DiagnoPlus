...
class Receipt4 extends StatefulWidget {
  // const Receipt({Key? key}) : super(key: key);

  @override
  _Receipt4State createState() => _Receipt4State();
}

class _Receipt4State extends State<Receipt4> {
  User user;
  UserModel userModel;
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                margin: EdgeInsets.only(left: 10,bottom: 15),
                child: Text("Time: 10:30",style: TextStyle(fontSize: 20),),
              ),
            ],
          ),
          Divider(
