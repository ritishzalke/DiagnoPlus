...
class Receipt8 extends StatefulWidget {
  // const Receipt({Key? key}) : super(key: key);

  @override
  _Receipt8State createState() => _Receipt8State();
}

class _Receipt8State extends State<Receipt8> {
  User user;
  UserModel userModel;
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                margin: EdgeInsets.only(left: 10,bottom: 15),
                child: Text("Time: 10:00",style: TextStyle(fontSize: 15),),
              ),
            ],
          ),
          Divider(
