...
class Receipt7 extends StatefulWidget {
  // const Receipt({Key? key}) : super(key: key);

  @override
  _Receipt7State createState() => _Receipt7State();
}

class _Receipt7State extends State<Receipt7> {
  User user;
  UserModel userModel;
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                margin: EdgeInsets.only(left: 10,bottom: 15),
                child: Text("Time: 9:00",style: TextStyle(fontSize: 15),),
              ),
            ],
          ),
          Divider(
