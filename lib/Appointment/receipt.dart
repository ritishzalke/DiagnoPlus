...
class _ReceiptState extends State<Receipt> {
  ...
  // Future<DateTime> dateprint() async
  // {
  //   await datetime.selec
  // }
  // getDate() async{
  //   await a.selectDate();
  // }
    ...
    return Scaffold(
      ...
      Row(
        children: [
          Container(
            ...
            child: Text("Doctor's Name: Doctor 1", style: TextStyle(fontSize: 20),),
          ),
      ]
      ),
      FittedBox(
        ...
        child: Row(
          ...
          // Text(datetime==null?"No date Chosen!":"Date chosen:${DateFormat.yMd().format(selectDate())}",style: TextStyle(fontSize: 20),),
          ...
          // Row(
          //   children: [
          //     Text(a.selectda==null?"No date Chosen!":"Date chosen:${DateFormat.yMd().format(datetime)}",style: TextStyle(fontSize: 20),),
          //   ],
          // ),
          Row(
            children: [
      ...
      Row(
        children: [
          Container(
            margin: EdgeInsets.only(left: 10,bottom: 15),
            child: Text("Time: 8:30 ",style: TextStyle(fontSize: 20),),
          ),
          ],
      ),
